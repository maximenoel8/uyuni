...
# Ported from features/support/constants.rb
...
PARENT_CHANNEL_LABEL_TO_SYNC_BY_BASE_CHANNEL = {
    "SUSE Manager": {
        "SLE-Product-SUSE-Manager-Proxy-4.3-Pool for x86_64": "sle-product-suse-manager-proxy-4.3-pool-x86_64",
        "SLES12-SP5-Pool for x86_64": None,
        "SLE-Product-SLES15-SP3-Pool for x86_64": "sle-product-sles15-sp3-pool-x86_64",
        "SLE-Product-SLES15-SP4-Pool for x86_64": "sle-product-sles15-sp4-pool-x86_64",
        "SLE-Product-SLES15-SP5-Pool for x86_64": "sle-product-sles15-sp5-pool-x86_64",
        "SLE-Product-SLES15-SP6-Pool for x86_64": "sle-product-sles15-sp6-pool-x86_64",
        ...
        "SL-Micro-6.1-Pool for x86_64": "sl-micro-6.1-pool-x86_64",
        "SL-Micro-6.2-Pool for x86_64": "sl-micro-6.2-pool-x86_64",
        "almalinux8 for x86_64": None,
        "almalinux9 for x86_64": None,
        "almalinux10 for x86_64": None,
        "amazonlinux2023 for x86_64": None,
        "Fake-Base-Channel-SUSE-like": None,
        "RHEL x86_64 Server 7": "rhel-x86_64-server-7",
        "RES-7-LTSS-Updates for x86_64": None,
        "EL9-Pool for x86_64": "el9-pool-x86_64",
        "oraclelinux9 for x86_64": None,
        "oraclelinux10 for x86_64": None,
        "RHEL8-Pool for x86_64": None,
        "rockylinux-8 for x86_64": None,
        "rockylinux-9 for x86_64": None,
        "rockylinux-10 for x86_64": None,
        "ubuntu-2204-amd64-main for amd64": None,
        "ubuntu-2404-amd64-main for amd64": None,
        "debian-12-pool for amd64": "debian-12-pool-amd64",
        "openSUSE-Leap-15.6-Pool for aarch64": None,
        "openSUSE-Leap-16.0 for aarch64": None,
    },
    "Uyuni": {
        "openSUSE Leap 15.6 (x86_64)": None,
        "openSUSE Leap Micro 5.5 (x86_64)": "opensuse_micro5_5-x86_64",
        "openSUSE Tumbleweed (x86_64)": None,
        "SLES12-SP5-Pool for x86_64": None,
        "SLE-Product-SLES15-SP3-Pool for x86_64": "sle-product-sles15-sp3-pool-x86_64",
        "SLE-Product-SLES15-SP4-Pool for x86_64": "sle-product-sles15-sp4-pool-x86_64",
        "SLE-Product-SLES15-SP5-Pool for x86_64": "sle-product-sles15-sp5-pool-x86_64",
        ...
        "SL-Micro-6.1-Pool for x86_64": "sl-micro-6.1-pool-x86_64",
        "SL-Micro-6.2-Pool for x86_64": "sl-micro-6.2-pool-x86_64",
        "AlmaLinux 8 (x86_64)": None,
        "AlmaLinux 9 (x86_64)": None,
        "Amazon Linux 2023 x86_64": None,
        "Fake-Base-Channel-SUSE-like": None,
        "CentOS 7 (x86_64)": "centos-7-x86_64-uyuni",
        "EL9-Pool for x86_64": "el9-pool-x86_64",
        "Oracle Linux 9 (x86_64)": None,
        "Rocky Linux 8 (x86_64)": None,
        "Rocky Linux 9 (x86_64)": None,
        "Ubuntu 22.04 LTS AMD64 Base for Uyuni": None,
        "Ubuntu 24.04 LTS AMD64 Base for Uyuni": None,
        "Debian 12 (bookworm) pool for amd64 for Uyuni": "debian12-amd64-uyuni",
        "openSUSE Leap 15.6 (aarch64)": None,
        "openSUSE Leap 16.0 (aarch64)": None,
    },
}
...
TIMEOUT_BY_CHANNEL_NAME = {
    ...
    "opensuse_leap15_6-aarch64": 10020,
    ...
    "opensuse_leap15_6-x86_64": 10380,
    ...
    "opensuse_tumbleweed-x86_64": 12600,
    ...
    "suse-multi-linux-manager-proxy-5.2-x86_64": 60,
    ...
    "suse-multi-linux-manager-retail-branch-server-5.2-x86_64": 60,
    ...
    "ubuntu-2204-amd64-universe-uyuni": 24000,
    ...
    "ubuntu-2404-amd64-universe-uyuni": 24000,
