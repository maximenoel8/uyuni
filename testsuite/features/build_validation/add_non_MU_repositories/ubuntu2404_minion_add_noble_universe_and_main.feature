...
Feature: Ubuntu 24.04: Universe and Main Noble Repositories Integration
  ...
  Scenario: Perform partial sync of python3-rpm and its dependencies into the Noble channel
    Given I use spacewalk-repo-sync to sync channel "ubuntu-2404-noble-amd64" including "python3-rpm librpm9t64 librpmbuild9t64 librpmio9t64 librpmsign9t64 rpm-common liblua5.3-0 libfsverity0" packages
