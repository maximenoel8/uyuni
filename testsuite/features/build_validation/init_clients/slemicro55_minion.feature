...
Feature: Bootstrap a SLE Micro 5.5 Salt minion
  ...
  Scenario: Bootstrap a SLE Micro 5.5 minion
    When I follow the left menu "Systems > Bootstrapping"
    Then I should see a "Bootstrap Minions" text
    When I enter the hostname of "slemicro55_minion" as "hostname"
    And I enter "22" as "port"
    And I enter "root" as "user"
    And I enter "linux" as "password"
    And I select "1-slemicro55_minion_key" from "activationKeys"
  ...
  Scenario: Check the new bootstrapped SLE Micro 5.5 minion in System Overview page
    ...
    And the Salt master can reach "slemicro55_minion"
...
@proxy
  Scenario: Check registration on proxy of SLE Micro 5.5 minion
    Given I am on the Systems overview page of this "proxy"
    When I follow "Details" in the content area
    And I follow "Proxy" in the content area
    Then I should see "slemicro55_minion" hostname
