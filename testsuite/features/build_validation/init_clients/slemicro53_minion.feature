...
Feature: Bootstrap a SLE Micro 5.3 Salt minion
  ...
  Scenario: Bootstrap a SLE Micro 5.3 minion
    When I follow the left menu "Systems > Bootstrapping"
    Then I should see a "Bootstrap Minions" text
    When I enter the hostname of "slemicro53_minion" as "hostname"
  ...
  Scenario: Reboot the SLE Micro 5.3 minion and wait until reboot is completed
    Given I am on the Systems overview page of this "slemicro53_minion"
...
@proxy
  Scenario: Check registration on proxy of SLE Micro 5.3 minion
    Given I am on the Systems overview page of this "proxy"
    When I follow "Details" in the content area
    And I follow "Proxy" in the content area
    Then I should see "slemicro53_minion" hostname

  Scenario: Check events history for failures on SLE Micro 5.3 minion
    Given I am on the Systems overview page of this "slemicro53_minion"
