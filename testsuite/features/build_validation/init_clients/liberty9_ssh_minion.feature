...
Feature: Bootstrap a Liberty Linux 9 Salt SSH minion
  ...
  Scenario: Clean up sumaform leftovers on a Liberty Linux 9 Salt SSH minion
    When I perform a full salt minion cleanup on "liberty9_ssh_minion"

  Scenario: Log in as admin user
    Given I am authorized for the "Admin" section

  Scenario: Bootstrap a Liberty Linux 9 Salt SSH minion
    When I follow the left menu "Systems > Bootstrapping"
    Then I should see a "Bootstrap Minions" text
    When I check "manageWithSSH"
    And I enter the hostname of "liberty9_ssh_minion" as "hostname"
...
@proxy
  Scenario: Check connection from Liberty Linux 9 Salt SSH minion to proxy
...
@proxy
  Scenario: Check registration on proxy of Liberty Linux 9 Salt SSH minion
