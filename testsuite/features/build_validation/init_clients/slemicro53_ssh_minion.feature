...
Feature: Bootstrap a SLE Micro 5.3 Salt SSH minion
  ...
  Scenario: Bootstrap a SLE Micro 5.3 SSH minion
    When I follow the left menu "Systems > Bootstrapping"
    Then I should see a "Bootstrap Minions" text
    When I check "manageWithSSH"
    And I enter the hostname of "slemicro53_ssh_minion" as "hostname"
...
@proxy
  Scenario: Check connection from SLE Micro 5.3 minion to proxy
    Given I am on the Systems overview page of this "slemicro53_ssh_minion"
    When I follow "Details" in the content area
    And I follow "Connection" in the content area
    Then I should see "proxy" short hostname

@proxy
  Scenario: Check registration on proxy of SLE Micro 5.3 SSH minion
    Given I am on the Systems overview page of this "proxy"
    When I follow "Details" in the content area
    And I follow "Proxy" in the content area
    Then I should see "slemicro53_ssh_minion" hostname

  Scenario: Check events history for failures on SLE Micro 5.3 SSH minion
    Given I am on the Systems overview page of this "slemicro53_ssh_minion"
